(function () {
  ...
  var UI_DICT = {
    ...
    'Peças': 'Pieces',
    'Explore a origem, o produtor e o destino gastronómico de cada peça MeatAzores.': 'Explore the origin, the producer and the gastronomic destination of every MeatAzores piece.',
    'Ainda não existem peças registadas.': 'There are no pieces registered yet.',
    'Não foi possível carregar as peças.': 'Could not load the pieces.',
    'Scan': 'Scan',
    'Aponte a câmara ao QR Code da peça para conhecer a sua origem.': 'Point the camera at the QR Code of a piece to discover its origin.',
    'Iniciar scan': 'Start scan',
    'Parar': 'Stop',
    'A abrir peça...': 'Opening piece...',
    'QR Code não é da MeatAzores.': 'QR Code is not from MeatAzores.',
    'Permissão da câmara negada. Ative o acesso nas definições do navegador.': 'Camera permission denied. Enable access in your browser settings.',
    'Não foi encontrada nenhuma câmara neste dispositivo.': 'No camera was found on this device.',
    'A câmara está a ser usada por outra aplicação.': 'The camera is being used by another application.',
    'Não foi possível iniciar a câmara.': 'Could not start the camera.',
    'Não foi possível carregar o leitor de QR. Verifique a ligação à internet.': 'Could not load the QR reader. Check your internet connection.',
    'Ver peça': 'View piece',
